...
//    }
    ...
    private static void printCpu(CentralProcessor processor) {
        ...
        System.out.format("CPU load: %.1f%%", processor.getSystemCpuLoadBetweenTicks(prevTicks) * 100);
        oshi.add(String.format("CPU load: %.1f%%", processor.getSystemCpuLoadBetweenTicks(processor.getSystemCpuLoadTicks()) * 100));
